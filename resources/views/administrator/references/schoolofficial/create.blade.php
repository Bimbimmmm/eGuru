...
<div class="container px-4 sm:px-8">
  <div class="py-8">
    <div>
      <h2 class="text-2xl text-center leading-tight">TUGASKAN KEPALA SEKOLAH</h2>
    </div>
    <div class="p-10 md:w-3/4 lg:w-1/2 mx-auto">
      ...
      @endforeach
      @endif
      <form action="/administrator/reference/schoolofficial/store" method="POST" class="w-full max-w-lg">
        @csrf
