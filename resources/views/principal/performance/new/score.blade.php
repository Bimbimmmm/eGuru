  ...
  <div class="px-5 mx-auto max-w-7x1">
    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
          ...
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td class="px-4 py-3 text-ms border">
                <a class="text-blue-500 underline" href="{{ asset('storage/performancetarget/activity/' . $data->file) }}">
                  {{$data->file}}
                </a>
              </td>
            </tr>
      ...
      <div class="md:flex md:justify-center md:space-x-8 md:px-14 bg-white mt-10">
        <form action="{{ route('principalnptscoreact', array($data->id, $idpt))}}" method="POST" class="w-full max-w-lg mt-10">
          ...
          <div class="flex flex-col -mx-3 mb-6">
            <div class="w-full px-3">
              <label class="block dark:text-white uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                Realisasi Kuantitas <span class="text-xs text-red-500"><i>*required</i>
              </label>
              <input name="realization_qty" id="realization_qty" placeholder="Masukkan Realisasi Kuantitas" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" required>
            </div>
          </div>
          <div class="flex flex-col -mx-3 mb-6">
            <div class="w-full px-3">
              <label class="block dark:text-white uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                Realisasi Mutu <span class="text-xs text-red-500"><i>*required</i>
              </label>
              <input name="realization_quality" id="realization_quality" placeholder="Masukkan Realisasi Mutu" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" required>
            </div>
          </div>
          <div class="flex flex-col -mx-3 mb-6">
            <div class="w-full px-3">
              <label class="block dark:text-white uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                Realisasi Waktu <span class="text-xs text-red-500"><i>*required</i>
              </label>
              <input name="realization_time" id="realization_time" placeholder="Masukkan Realisasi Waktu" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="number" min="1" max="12"required>
            </div>
          </div>
