    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        ...
        <table class="w-full">
          ...
          <tbody class="bg-white">
            ...
            <tr>
              ...
              @if($activity->weighted_value == null)
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <p class="text-gray-900 whitespace-no-wrap">
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <a href="/principal/newperformance/score/{{$activity->id}}/{{$data->id}}" class="text-green-600 hover:text-green-400 ml-2">
        ...
        <table class="w-full">
          ...
          <tbody class="bg-white">
            ...
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                <a href="/principal/newperformance/workbehavior/show/{{$workbehaviour->id}}/{{$data->id}}" class="text-green-600 hover:text-green-400 ml-2">
                  <i class="material-icons-round text-base">visibility</i>
                </a>
              </td>
              @else
      ...
      <div class="flex items-center justify-center mt-10">
        <div class="w-full max-w-md mr-4">
          <form action="{{ route('principalnptwbcreate', $data->id)}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-green-500">
            @csrf
      ...
      <div class="flex items-center justify-center mt-10">
        <div class="w-full max-w-md mr-4">
          <form action="{{ route('principalnptdone', $data->id)}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-red-500">
            @csrf
            <div class="text-gray-800 text-2xl flex justify-center border-b-2 py-2 mb-4">
