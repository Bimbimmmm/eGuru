    ...
    <div class="w-48">
      <div class="my-2 flex sm:flex-row flex-col">
        <div class="block relative">
          <a class="text-white" href="/teacher/newpromotion/create">
      ...
      <table class="w-full">
        ...
        <tbody class="bg-white">
          ...
          <tr class="text-gray-700 text-center">
            ...
            <td class="px-4 py-3 text-ms border">{{$data->newAssementCredit->newPerformanceTarget->assessment_year}}</td>
            ...
            <td class="px-4 py-3 text-sm border">
              ...
              <a href="{{ url ('/teacher/newpromotion/pdf', array("$data->id")) }}">
            ...
            @endif
            <td class="px-4 py-3 text-sm border">
              <a href="{{ url ('/teacher/newpromotion/show', array("$data->id")) }}" class="text-green-600 hover:text-green-400 mr-2">
