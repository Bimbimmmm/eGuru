        ...
        <div class="columns">
          <div class="column">
            <table class="is-fullwidth">
              <tr>
                <td>Nomor : 820.2/{{$decree_head}}/Disdik-I/{{$get_decree_number->month}}/{{$get_decree_number->year}}</td>
              </tr>
              <tr>
                <td>Lampiran : -</td>
              </tr>
              <tr>
                <td>Perihal : Kenaikan Gaji Berkala a.n {{$data->user->personalData->name}}</td>
              </tr>
            </table>
          </div>
          <div class="column">
            <div class="columns">
              ...
              <div class="column">
                <table class="is-fullwidth">
                  ...
                  <tr>
                    <td>Bendaharawan Gaji Sekretariat Daerah</td>
                  </tr>
                  <tr>
              ...
              <div class="column">
                <table class="is-centered custom_table"  style="border: 0px solid transparent;">
                  <tr>
                    ...
                    <tr>
                        <td>
                          {!! QrCode::size(65)->generate($officialqrcode); !!}
                        </td>
                    </tr>
                    <tr>
                        <td>
