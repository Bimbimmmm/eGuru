  ...
  <div class="px-5 mx-auto max-w-7x1">
    ...
    <div class="my-2 flex sm:flex-row flex-col">
      <div class="block relative">
        <a class="text-white" href="/teacher/newperformance/create">
    ...
    <div class="mx-4 sm:mx-8 px-4 sm:px-8 py-4 overflow-x-auto ">
      <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
        <div class="flex bg-blue-500 rounded-lg p-4 mb-4 text-sm text-white" role="alert">
            <svg class="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
            <div>
                <span class="font-medium">Perhatian!</span> Pembuatan Sasaran Kinerja Pegawai (SKP) Pada Aplikasi Ini Sesuai Dengan Peraturan Pemerintah (PP) Nomor 30 Tahun 2019
            </div>
        </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                ...
                @if($data->is_ready == FALSE)
                <a href="/teacher/newperformance/destroy/{{$data->id}}" class="text-red-600 hover:text-red-400 ml-2">
