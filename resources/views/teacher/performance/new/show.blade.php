    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        ...
        <table class="w-full">
          <tbody class="bg-white">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td colspan="3" class="px-4 py-3 text-ms border font-semibold">
                <a href="/teacher/newperformance/show/planning/{{$data->id}}">
            ...
            <tr class="text-gray-700 text-center">
              ...
              <td colspan="3" class="px-4 py-3 text-ms border font-semibold">
                <a href="/teacher/newperformance/show/realization/{{$data->id}}">
                  <span class="inline-block rounded-min text-white bg-green-500 px-2 py-1 text-xs font-bold mr-3">Lihat</span>
                </a>
              </td>
            </tr>
            <tr class="text-gray-700 text-center">
              ...
              <td colspan="3" class="px-4 py-3 text-ms border font-semibold">
                <a href="/teacher/newperformance/show/dp3/{{$data->id}}">
                  <span class="inline-block rounded-min text-white bg-green-500 px-2 py-1 text-xs font-bold mr-3">Lihat</span>
                </a>
              </td>
            </tr>
      ...
      <div class="w-full overflow-x-auto py-5">
        ...
        <div class="my-2 flex flex-row">
          <div class="block relative">
            <a class="text-white" href="/teacher/newperformance/activity/create/main/{{$data->id}}">
          ...
          <div class="block relative">
            <a class="text-white" href="/teacher/newperformance/activity/create/additional/{{$data->id}}">
              <div class="mx-4 sm:mx-8 w-auto flex items-center p-4 bg-green-500 rounded-lg shadow-xs cursor-pointer hover:bg-green-400 hover:text-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                </svg>
            ...
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <p class="text-gray-900 whitespace-no-wrap">
                  ...
                  <a href="/teacher/newperformance/activity/show/{{$activity->id}}/{{$data->id}}" class="text-green-600 hover:text-green-400 ml-2">
              ...
              @if($data->is_ready == FALSE)
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <a href="/teacher/newperformance/activity/delete/{{$activity->id}}" class="text-red-600 hover:text-red-400 ml-2">
      ...
      <div class="flex items-center justify-center mt-10">
        <div class="w-full max-w-md mr-4">
          <form action="{{ route('teachernptlock', $data->id)}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-red-500">
            @csrf
