...
<div class="min-h-screen bg-white py-14">
  <div class="px-5 mx-auto max-w-7x1">
    <h1 class="mb-12 text-center text-3xl text-black font-bold">Form Penambahan Kinerja Tambahan</h1>
    <div class="md:flex md:justify-center md:space-x-8 md:px-14">
      <form action="{{ route('teachernptastoreadditional', $id)}}" method="POST" class="w-full max-w-lg">
        @csrf
        @if(session('errors'))
        ...
        <div class="flex flex-col -mx-3 mb-6">
          <div class="w-full px-3">
            ...
            <input name="target_qty" id="target_qty" placeholder="Masukkan Target Kuantitas" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" required>
          </div>
        </div>
        <div class="flex flex-col -mx-3 mb-6">
          <div class="w-full px-3">
        ...
        <div class="flex flex-col -mx-3 mb-6">
          <div class="w-full px-3">
            ...
            <input name="target_time" id="target_time" placeholder="Masukkan Target Waktu" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="number" required>
          </div>
        </div>
