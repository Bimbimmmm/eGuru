    ...
    <div class="mx-4 sm:mx-8 px-4 sm:px-8 py-4 overflow-x-auto ">
      ...
      <div class="flex items-center justify-center mt-10">
        <div class="w-full max-w-md mr-4">
          <form action="{{ route('officeheadprapprove', array("$data->id"))}}" method="POST" class="bg-white shadow-lg rounded px-12 pt-6 pb-8 mb-4 border-2 border-green-500">
            @csrf
            ...
            <div class="mb-6 text-center">
              <label class="block text-gray-700 text-sm font-normal mb-2" for="password">
                Pengajuan Kenaikan Pangkat Telah Diperiksa oleh {{$data->asseseed_by}} Secara Seksama dengan Hasil Akhir Diterima
                dengan Masa Kerja Golongan Baru : {{$data->new_work_year}}
              </label>
            </div>
