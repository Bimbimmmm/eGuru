...
<body class="font-roboto">
  ...
  <nav class="sticky top-0 z-50 bg-white">
    ...
    <div class="p-4 flex flex-row items-center justify-between">
      <a href="/divisionhead" class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">eGuru</a>
      ...
      <div class="w-full pt-12 flex flex-col sm:flex-row space-y-2 justify-start">
        <div class="w-full sm:w-2/5 pr-6 flex flex-col space-y-4">
          <a class="title-font font-medium items-center md:justify-start justify-center">
            <image width="100" height="50" src="{{ asset('images/logo.png') }}"/>
            <p>Dinas Pendidikan Kabupaten Tana Tidung</p>
          </a>
          <p class="mt-0">Jl. Perintis, Desa Tideng Pale, Kecamatan Sesayap, Kabupaten Tana Tidung, Provinsi Kalimantan Utara, 77152</p>
        </div>
      </div>
      <div class="opacity-60 pt-2">
        <p>© 2021 SIDIK X SIMACAN</p>
      </div>
    </div>
  </footer>
</div>
